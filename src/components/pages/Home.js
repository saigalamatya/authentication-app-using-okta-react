  ...
  render() {
    ...
    const mainContent = this.state.authenticated ? (
      <div>
        ...
        <button className="btn btn-light btn-loginlg" onClick={this.logout}>Logout</button>
      </div>
    ) : (
      <div>
        <p className="lead">If you are a staff member, please get your credentials from 
        your supervisor</p>
